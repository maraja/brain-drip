...
export { default as updateLearningPath } from "./updateLearningPath";
export { default as deleteLearningPath } from "./deleteLearningPath";
export { default as createLearningBucket } from "./createLearningBucket";
export { default as updateLearningBucket } from "./updateLearningBucket";
export { default as deleteLearningBucket } from "./deleteLearningBucket";
...
export { default as deleteLearningPathResource } from "./deleteLearningPathResource";
...
export { default as deleteLearningBucketResource } from "./deleteLearningBucketResource";
